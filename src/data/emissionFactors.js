...
export const EMISSION_FACTORS = {
  transport: {
    car_petrol: { factor: 0.21, unit: 'km', label: 'Car (Petrol)', icon: '🚗', category: 'transport' },
    car_diesel: { factor: 0.27, unit: 'km', label: 'Car (Diesel)', icon: '🚙', category: 'transport' },
    car_electric: { factor: 0.05, unit: 'km', label: 'Electric Car', icon: '⚡', category: 'transport' },
    car_hybrid: { factor: 0.12, unit: 'km', label: 'Hybrid Car', icon: '🔋', category: 'transport' },
    ...
    motorcycle: { factor: 0.103, unit: 'km', label: 'Motorcycle', icon: '🏍️', category: 'transport' },
    ...
    auto_rickshaw: { factor: 0.08, unit: 'km', label: 'Auto Rickshaw', icon: '🛺', category: 'transport' },
  },
  ...
  food: {
    ...
    meal_vegetarian: { factor: 1.7, unit: 'meal', label: 'Vegetarian Meal', icon: '🥗', category: 'food' },
    meal_mixed: { factor: 3.5, unit: 'meal', label: 'Mixed Meal', icon: '🍽️', category: 'food' },
    meal_meat_heavy: { factor: 7.0, unit: 'meal', label: 'Meat-heavy Meal', icon: '🥩', category: 'food' },
  },
  ...
  energy: {
    ...
    solar_panel: { factor: -0.5, unit: 'kWh', label: 'Solar (offset)', icon: '☀️', category: 'energy' },
    ac_usage: { factor: 1.5, unit: 'hour', label: 'Air Conditioning', icon: '❄️', category: 'energy' },
    fan_usage: { factor: 0.04, unit: 'hour', label: 'Fan/Cooler', icon: '🌀', category: 'energy' },
  },

  shopping: {
    clothing_new: { factor: 10, unit: 'item', label: 'New Clothing', icon: '👕', category: 'shopping' },
    clothing_second: { factor: 0.5, unit: 'item', label: 'Secondhand Clothing', icon: '♻️', category: 'shopping' },
    electronics_phone: { factor: 70, unit: 'item', label: 'Smartphone', icon: '📱', category: 'shopping' },
    electronics_laptop: { factor: 300, unit: 'item', label: 'Laptop', icon: '💻', category: 'shopping' },
    furniture: { factor: 50, unit: 'item', label: 'Furniture', icon: '🪑', category: 'shopping' },
    plastic_bag: { factor: 0.033, unit: 'item', label: 'Plastic Bag', icon: '🛍️', category: 'shopping' },
    online_delivery: { factor: 0.5, unit: 'package', label: 'Online Delivery', icon: '📦', category: 'shopping' },
  },

  digital: {
    video_streaming: { factor: 0.036, unit: 'hour', label: 'Video Streaming', icon: '📺', category: 'digital' },
    video_call: { factor: 0.047, unit: 'hour', label: 'Video Call', icon: '💻', category: 'digital' },
    email: { factor: 0.004, unit: 'email', label: 'Email', icon: '📧', category: 'digital' },
    cloud_storage: { factor: 0.013, unit: 'GB/month', label: 'Cloud Storage', icon: '☁️', category: 'digital' },
    social_media: { factor: 0.02, unit: 'hour', label: 'Social Media', icon: '📲', category: 'digital' },
  ...
  waste: {
    ...
    recycling: { factor: 0.021, unit: 'kg', label: 'Recycled Waste', icon: '♻️', category: 'waste' },
    composting: { factor: 0.01, unit: 'kg', label: 'Composted Waste', icon: '🌿', category: 'waste' },
    food_waste: { factor: 2.53, unit: 'kg', label: 'Food Waste', icon: '🍌', category: 'waste' },
  },
};

export const CATEGORIES = {
  transport: { label: 'Transport', icon: '🚗', color: '#0EA5E9', description: 'Daily commute & travel' },
  food: { label: 'Food & Diet', icon: '🍽️', color: '#10B981', description: 'Meals & dietary choices' },
  energy: { label: 'Home Energy', icon: '⚡', color: '#F59E0B', description: 'Electricity, gas & heating' },
  shopping: { label: 'Shopping', icon: '🛒', color: '#8B5CF6', description: 'Products & purchases' },
  digital: { label: 'Digital', icon: '💻', color: '#EC4899', description: 'Internet & device usage' },
